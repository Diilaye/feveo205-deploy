...
const ProfileSettings = () => {
    ...
    const fetchProfile = async () => {
        try {
            ...
            const response = await axios.get(`${API_URL}/admin/profil`, {
    ...
    const handleProfileSubmit = async (e) => {
        ...
        try {
            setLoading(true);
            const token = localStorage.getItem('adminAuthToken');
            const response = await axios.put(`${API_URL}/admin/profil`, profileData, {
                headers: { Authorization: `Bearer ${token}` }
            });
            if (response.data.success) {
                ...
                if (storedAdmin) {
                    ...
                    adminData.nom = profileData.nom;
                    adminData.prenom = profileData.prenom;
    ...
    const handlePasswordSubmit = async (e) => {
        ...
        try {
            setLoading(true);
            const token = localStorage.getItem('adminAuthToken');
            const response = await axios.put(`${API_URL}/admin/profil/mot-de-passe`, passwordData, {
                headers: { Authorization: `Bearer ${token}` }
            });
            if (response.data.success) {
